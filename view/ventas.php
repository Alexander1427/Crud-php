...
<body>
    ...
    ***********************************-->
    ...
    <form action="../server/venta.php" method="post">
        ...
        <input type="text" class="form-control" name="cliente" id="cliente"  aria-describedby="emailHelp" required>
            </div>
    <div class="mb-3">
        <label for="nombre" class="form-label">Producto</label>
        <input type="text" class="form-control" name="producto" id="producto" value="<?php echo $nombre  ?>" aria-describedby="emailHelp" required>
