			...
			<div class="container-fluid">
				<div class="form-head d-flex flex-wrap mb-sm-4 mb-3 align-items-center">
					...
					<div class="dropdown custom-dropdown mb-3">
						<div class="btn btn-sm date-ds-btn btn-rounded d-flex align-items-center svg-btn mr-3" data-toggle="dropdown">
							...
							<i class="fa fa-caret-down scale5 ml-3"></i>
						</div>
					...
					<a href="javascript:void(0);"  data-toggle="modal" data-target="#addOrderModal" class="btn btn-primary btn-rounded mb-3"><i class="fa fa-user-plus mr-3"></i>New Admission</a>
					<!-- Add Order -->
									...
									<div class="card-body pb-0">
										<div class="d-flex flex-wrap">	
											<div class="media  align-items-center mb-3">
												<div class="d-inline-block position-relative mr-sm-3 mr-2">
												...
												<div class="media-body mr-sm-4 mr-3">	
											...
											<div class="media align-items-center mb-3">
												...
												<div class="media-body mr-sm-4 mr-0">	
